...
var MainPaneDiv = _styledComponents2.default.div(_templateObject, 12 / 5, 12 / 5);
...
var ThumbPane = function ThumbPane(_ref) {
  ...
  var activeItem = items.filter(function (item) {
    return Number(item.id) === activeItemId;
  })[0];
...
//# sourceMappingURL=1.c72fcd854dd6c30e7b02.bundle.js.map?v=1.0.11