...
var initGallery = function initGallery(container, items) {
  _reactDom2.default.render(_react2.default.createElement(_ThumbnailGallery2.default, { items: items }), container);
};
